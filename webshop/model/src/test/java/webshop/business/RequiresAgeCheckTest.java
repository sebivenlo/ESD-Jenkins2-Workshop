...
public class RequiresAgeCheckTest {
    ...
    public void testAgeOk() {
        ...
        assertFalse( "null is false", ageCheck1.ageOk( null ) );
        assertTrue( "realy old", ageCheck1.ageOk( LocalDate.MIN ) );
        assertFalse( "too young", ageCheck1.ageOk( LocalDate.now().minus(
                Period.of( 17, 0, 1 ) ) ) );
        LocalDate justToYoung
                = LocalDate.MAX.now().minusYears( 18 ).plusDays( 1 );
        ...
        assertTrue( "18, may boose now, are you happy?", ageCheck1.ageOk(
                happyNow ) );
        assertTrue( "author", ageCheck1.ageOk( LocalDate.of( 1955, Month.MARCH,
                18 ) ) );
    }
