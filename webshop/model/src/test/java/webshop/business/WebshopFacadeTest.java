...
import static webshop.persistence.mappers.WebshopFactoryConfigurator.MEMORY_CONFIG;
...
public class WebshopFacadeTest {
    ...
    AbstractWebshopFactory factory
            = WebshopFactoryConfigurator.CONFIGURATOR
            .getFactory( MEMORY_CONFIG );
    ...
    public void testAddToCart_Product_int() throws WebshopException {
        ...
        try {
            session.addToCart( noVATProduct );
